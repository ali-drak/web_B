...
<form method="post" action="" style=" margin-top: 1% ">
    <div class="form-group"> <center style="margin-bottom: 50px ;font-size: 40px"><label id="l7" > اسامی فرزندان  دریافت هزینه</label></center></div>
   <div class="form-group"> <center><label id="l1">:از سال</label></center>
    ...
    <div class="form-group"> <center style="margin-top: 20px"><button type="submit"  id="submit2_N_R_H" name="submit2_N_R_H" class="btn-success">جستجو</button> </center></div>
    <script>
        //    $("#save").click(function(){
